...
export AI_PROVIDER=none      # no model calls, fallback-only AI surfaces
export AI_PROVIDER=bedrock   # AWS Bedrock Claude, current hosted behavior
export AI_PROVIDER=local     # local model endpoint only
export LOCAL_ONLY=true       # optional hard guard against Bedrock/OpenAI clients
